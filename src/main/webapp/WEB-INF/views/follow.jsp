...
function unfollow(id){
	$.ajax({
		...
		success: function(data){
			if(data) {
				alert("이제 "+id+"님을 언팔로우합니다.")
				location.href="getfollowings.sf";
			}
...
<div class="card text-center">
  <div class="card-header">
    <ul class="nav nav-tabs card-header-tabs">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="getfollowings.sf">팔로잉</a>
      </li>
      <li class="nav-item">
			...
			<td>
				<div class="card">
					<div class="row no-gutters">
						<img onclick="userEatInfo('${u.getFollow()}')" src="profile.sf?id=${u.getFollow()}" class="card-img-top rounded-circle" id="profile">
						<div class="card-body">
